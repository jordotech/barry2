...
<div id="topblock">
  <?php if ($left): ?>
    <div class="groupleft<?php print $left_classes; ?>"><?php print "<h3>Contact Information</h3>"; ?>
      <?php print $left; ?>
    </div>
  <?php endif; ?>
  <?php if ($middle): ?>
    <div class="groupmiddle<?php print $middle_classes; ?>"><?php print "<h3>Contact Information</h3>"; ?>
      <?php print $middle; ?>
    </div>
  <?php endif; ?>
  <?php if ($right): ?>
    <div class="groupright<?php print $right_classes; ?>"> <?php print "<h3>Insurance Information</h3>"; ?>
      <?php print $right; ?>
    </div>
  <?php endif; ?>
  </div>
  <div id="middleblock">
  <?php print "<h3>Dates</h3>"; ?>
  <hr />
   <?php if ($leftmiddle): ?>
  ...
  <div id="bottomblock">
<?php print "<h3>Patient Status</h3>"; ?>
  <hr />
   <?php if ($leftbottom): ?>
